...
namespace Examples
{
    public class AdvertisementPanel : MonoBehaviour
    {
        ...
        private readonly List<BannerState> _lastBannerStates = new List<BannerState>();
        private readonly List<InterstitialState> _lastInterstitialStates = new List<InterstitialState>();
        private readonly List<RewardedState> _lastRewardedStates = new List<RewardedState>();
